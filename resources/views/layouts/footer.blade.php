<footer class="footer">
        ...
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <p><b><i class="fas fa-mobile-alt"></i> Hotline:</b> <a href="tel:(+84) 985843391">(+84) 985843391</a></p>
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="mailto:anhuquynhphambp1@gmail.com" rel="nofollow">anhuquynhphambp1@gmail.com</a></p>
              <p><b><i class="fas fa-store-alt"></i> Địa chỉ:</b> 79 Ngô Gia Tự - Chánh Nghĩa - Thủ Dầu Một - Bình Dương </p>
            </div>
          </div>
        </div>
  ...
  <div class="footer-bottom">
    <div class="copyright text-center">
      Copyright &copy 2020 Thanh Tân. All rights reserved.
    </div>
  </div>
</footer>
